...
```
The one that we need is. The others check your architecture and point you to correct headers, and since our program was compiled for x86, we use actually use the following header file:
/usr/include/asm/unistd_32.h
```bash
